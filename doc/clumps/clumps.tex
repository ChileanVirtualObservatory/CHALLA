...
\newcommand{\myemail}{maray@inf.utfsm.cl}
...
\shorttitle{Improved Clump Detection Using Gaussians}
\shortauthors{Araya et al.}
...
\title{Improved Clump Detection Using Gaussians}
...
\author{Mauricio Araya\altaffilmark{1} and Mauricio Solar\altaffilmark{2}}
\affil{Astronomy Department, University of California,
    Berkeley, CA 94720}

\author{Eduardo Ibar\altaffilmark{3}} 
\affil{National Optical Astronomy Observatories, Tucson, AZ 85719}
\email{aastex-help@aas.org}

\and

\author{Diego Mardones\altaffilmark{4}}
...
\bibitem[Stutzki \& G\"usten(1990)]{Stutzki90} Stutzki J., G\"usten R., 1990,
\apj, 365, 513 (SG90)
\end{thebibliography}
